...
class Routine extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('for_all, starttime, endtime, name, description', 'required'),
			array('for_all, user_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, for_all, starttime, endtime, user_id, name, description', 'safe', 'on'=>'search'),
		);
	}
